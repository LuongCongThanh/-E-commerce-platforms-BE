...
> [!WARNING]
> Legacy reference only. This file is kept for historical planning context.
> Use `docs/be/05-priority-implementation-backlog.vi.md` as the canonical backend backlog.
