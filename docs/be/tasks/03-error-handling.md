...
> [!WARNING]
> Legacy reference only. The wrapped `success/error` response example below is historical.
> Use the canonical error shape in `docs/be/01-mvp-overview.vi.md` and the structure rules in `docs/be/04-project-structure-guidelines-conventions.vi.md`.
