...
> [!WARNING]
> Legacy reference only. Keep this file as a quick RBAC note, but prefer the current canonical backend docs when permissions and API ownership rules conflict.
