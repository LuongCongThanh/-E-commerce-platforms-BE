...
> [!WARNING]
> Legacy planning note. Use `docs/be/01-mvp-overview.vi.md` and `docs/be/05-priority-implementation-backlog.vi.md` as the canonical source for current MVP API scope.
