...
> [!WARNING]
> Legacy planning note. Use `docs/be/04-project-structure-guidelines-conventions.vi.md` and `docs/be/05-priority-implementation-backlog.vi.md` as the current canonical implementation guides.
