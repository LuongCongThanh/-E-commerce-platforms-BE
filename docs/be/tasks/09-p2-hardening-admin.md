...
> [!WARNING]
> Legacy planning note. Use `docs/be/02-roadmap-and-execution-plan.vi.md` and `docs/be/05-priority-implementation-backlog.vi.md` for the current release-order and hardening priorities.
