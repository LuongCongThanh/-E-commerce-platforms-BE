...
> [!WARNING]
> Legacy reference only. Some structure and naming guidance in this file is outdated.
> Use `docs/be/04-project-structure-guidelines-conventions.vi.md` as the canonical source.
